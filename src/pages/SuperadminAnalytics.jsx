// src/pages/SuperadminAnalytics.jsx
    ...
    <div className="superadmin-main-container">
      <div className="superadmin-container">
        <div className="superadmin-analytics-page">
          <header className="superadmin-top-bar">
            <div className="superadmin-toggle-buttons">
              {tabs.map((tab) => (
                <button
                  key={tab}
                  className={`superadmin-toggle-button ${activeTab === tab ? 'active' : ''}`}
                  onClick={() => setActiveTab(tab)}
                >
                  {tab}
                </button>
              ))}
              <div className="superadmin-chatbot-toggle-icon" onClick={toggleChatBot}>
                <FaRobot />
              </div>
            </div>
          </header>
